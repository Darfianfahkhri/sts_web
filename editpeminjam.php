              ...
              < <?php
                ...
                <div class="box-body">
                  ...
                  <div class="form-group">
                    ...
                    <input type="text" value="<?php echo $qu['nama'] ?>" name="username" class="form-control" placeholder="" required>
                  </div>
                  <div class="form-group">
                  ...
                  <div class="form-group">
                    ...
                    <input type="text" disabled value="<?php echo $qu['kelas'] ?>" name="kelas" class="form-control" placeholder="" required>
                  </div>
